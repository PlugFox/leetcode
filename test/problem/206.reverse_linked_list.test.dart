...
void main() => group('reverse_linked_list', () {
      ...
      test('f([1])', () {
        expect(f(ListNode.of(<int>[1])), containsAllInOrder(<int>[1]));
      });

      test('f([1,2])', () {
        expect(f(ListNode.of(<int>[1, 2])), containsAllInOrder(<int>[2, 1]));
      });

      test('f([1,2,3,4,5])', () {
        expect(f(ListNode.of(<int>[1, 2, 3, 4, 5])), containsAllInOrder(<int>[5, 4, 3, 2, 1]));
      });
    });
